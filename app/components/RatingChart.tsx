  ...
  return (
    <Card className="flex flex-col border-none shadow-none h-full p-0 bg-white">
      <CardHeader className="items-start pb-0 px-6">
        <CardTitle className="text-base font-semibold text-slate-800">Your Rating</CardTitle>
        <CardDescription className="text-[11px] text-slate-400 font-medium">Lorem ipsum dolor sit amet, consectetur</CardDescription>
      </CardHeader>
      <CardContent className="flex-1 flex items-center justify-center p-0 mt-4 h-full">
        <div className="relative w-full h-full min-h-[220px] max-w-[320px] mx-auto flex items-center justify-center">
            {/* 85% Hygiene - Purple (TOP LAYER - Overlaps Orange) */}
            ...
            {/* 85% Food Taste - Orange (RIGHT SIDE - Largest) */}
